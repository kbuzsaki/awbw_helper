        ...
        if (this.coSelectPanel.hidden) {
            ...
            this.coSelectPanel.openPanel(rect, (coName) => {
                ...
                if (co !== undefined) {
                    ...
                    this.playerInfo.players_co_id = co.players_co_id;
                    this.playerInfo.co_name = co.name;
                    this.playerInfo.co_max_power = co.co_max_power;
                    this.playerInfo.co_max_spower = co.co_max_spower;
