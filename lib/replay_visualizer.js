...
class ReplayVisualizer {
    ...
    getSelectedDataset() {
        ...
        return {
            "Co Meter (Funds)": this.getCoMeterFundsData.bind(this),
            "Co Meter (Percent)": this.getCoMeterPercentData.bind(this),
    ...
    getCoMeterPercentData() {
        return this.getDataByTurn("CO Meter by Turn", (turnState, player) => {
            let meter = turnState.gameState.players[player.players_id].players_co_power;
            let maxMeter = turnState.gameState.players[player.players_id].players_co_max_spower;
