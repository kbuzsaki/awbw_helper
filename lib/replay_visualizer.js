    ...
    getSelectedDataset() {
        ...
        let metric = {
            "Co Meter (Funds)": {
                ...
                secondaryFn: ({playerMetrics}) => playerMetrics.max_meter_funds,
            },
            "Co Meter (Percent)": {
                title: "CO Meter",
            ...
            "Funds Generated": {
                ...
                fn: ({playerMetrics}) => playerMetrics.funds_generated,
            },
            "Unit Count": {
                title: "Unit Count",
            ...
            "Unit Value": {
                ...
                secondaryFn: ({playerMetrics}) => playerMetrics.unit_value_and_funds,
            },
        }[metricSelected];
        ...
        for (let label of labels) {
            ...
            for (let turn of turnsByLabel[label]) {
                for (let playerId in turn.player_metrics) {
                    ...
                    labelData.data.push(metric.fn({playerMetrics}));
                    if (metric.secondaryFn) {
                        labelData.secondary_data.push(metric.secondaryFn({playerMetrics}));
                    }
                }
            }
